...
คำที่ลูกค้าระบุว่าเป็น crisis ระดับรุนแรง (severity = high เมื่อพูดถึงในบริบทของแบรนด์/การฉีด):
  Nodule, หน้าเป็นก้อน, เป็นก้อน, ก้อน, ก้อนแข็ง, เป็นไต/ไต (ก้อนใต้ผิว), ตาบอด, เนื้อตาย, ยาปลอม/ของปลอม, ฉีดพลาด/ฉีดผิด, หน้าเบี้ยว
  (หมายเหตุ: "ก้อน/ไต" ต้องอยู่ในบริบทอาการหลังฉีด/แบรนด์ ไม่ใช่ความหมายทั่วไป เช่น ก้อนเมฆ/ไตวายในข่าวสุขภาพ)

นิยาม crisis (severity = high ถ้าอันตรายถึงชีวิต/ตา/ถาวร หรือมีแนวโน้มไวรัล):
- อาการไม่พึงประสงค์: เนื้อตาย/หน้าเน่า/ผิวซีดเป็นลายๆ/ปวดมาก (vascular occlusion), ตาบอด/ตามัว, โบกระจาย→หายใจ/กลืน/พูด/เคี้ยวลำบาก (botulism), แพ้รุนแรง/ช็อก (anaphylaxis), แผลไหม้/เนื้อยุบถาวร (HIFU), ติดเชื้อ/เป็นหนอง, หน้าเบี้ยว/ปากเบี้ยว, เป็นก้อน/ก้อนแข็ง/เป็นไต/nodule, ฟิลเลอร์ไหล, ฉีดพลาด/ฉีดผิดตำแหน่ง, ยาปลอม (ในเชิงผู้เสียหาย ไม่ใช่โพสต์ความรู้/เตือนเชิงวิชาการ)
